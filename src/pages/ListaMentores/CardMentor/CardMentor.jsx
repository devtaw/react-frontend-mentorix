      ...
      <Card.Body>
        <TagList>
          {especialidades.map((especialidade) => (
            <TextH5 key={especialidade} className={mapaDeEspecialidadesClass[especialidade]}>
              {mapaDeEspecialidades[especialidade]}
            </TextH5>
          ))}
        </TagList>
